...
- Rely on automated testing (Jest, Cypress) to keep changes safe and predictable  
- Use CI/CD pipelines (GitHub Actions, Docker) to ship reliably across environments  
- Comfortable working with Nginx and Cloudflare for multi-environment setups  
- Prefer clean, maintainable solutions over quick hacks

---

📍 Chiang Mai, Thailand  
🔗 LinkedIn: [phyaesonethwim](https://www.linkedin.com/in/phyaesonethwim)
